...
<div class="box-header with-border">
  <h1 class="box-title">Bonos y obsequios <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="idbono" id="idbono">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="text" class="form-control" name="total_bono" id="total_pago" placeholder="Bono" maxlength="20">
    </div>
       <div class="form-group col-lg-6 col-md-6 col-xs-12">
