...
<div class="box-header with-border">
  <h1 class="box-title">Lugar <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
require 'footer.php'
 ...
 <script src="scripts/lugar.js"></script>
