...
<div class="box-header with-border">
  <h1 class="box-title">Agregar estudiante</h1>
...
<div class="panel-body table-responsive" id="listadoregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="date" name="fecha_nacimiento" id="fecha_nacimiento" maxlength="12" placeholder="Fecha de nacimiento">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="date" name="fecha_expedicion" id="fecha_expedicion" maxlength="12" placeholder="Fecha de expedicion">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="direccion_residencia" id="direccion_residencia" maxlength="50" placeholder="Direccion de residencia">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Telefono:</label>
      <input class="form-control" type="text" name="telefono" id="telefono" maxlength="11" placeholder="Telefono">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="sangre" id="sangre" maxlength="5" placeholder="Tipo de sangre">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
